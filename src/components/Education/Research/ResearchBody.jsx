    ...
    return(
        ...
        <div class="flex flex-col text-gray-200">
            ...
            <div class="flex flex-col h-max ">
                <div class="bg-gray-800 flex flex-row justify-evenly h-full py-12 ">
                ...
                <div class="flex flex-col bg-gray-700 w-screen py-12">
                    <div class="self-center py-8 w-max">
                            <ol class="flex flex-col">
                                <h2 class="self-center font-semibold text-2xl pb-4">How to get started :</h2>
                                <li class="border-b-2 border-opacity-10 pt-4"><strong>1)</strong> Submit an application for SVOC in summer semester (titles are typically released around May/June)</li>
                                <li class="border-b-2 border-opacity-10 pt-4"><strong>2)</strong> Once accepted, arrange a meeting with your supervisor</li>
                                <li class="border-b-2 border-opacity-10 pt-4"><strong>3)</strong> Confirm your SVOC project title by the deadline (usually towards the end of winter semester)</li>
                                <li class="border-b-2 border-opacity-10 pt-4"><strong>4)</strong> Submit a 1 page abstract (Summer semester)</li>
                                <li class="border-b-2 border-opacity-10 pt-4"><strong>5)</strong> Submit a poster presentation (~ 1 month after abstract deadline)</li>
                                <li class="border-b-2 border-opacity-10 pt-4"><strong>6)</strong> Short Presentation followed by Q/A session at SVOC conference</li>
                            </ol>
                    </div>
                </div>
                <div class="text-black bg-gradient-to-br from-pink-50 to-indigo-100">
                    <h2 class="self-center font-semibold text-2xl pl-8 py-8">Frequently Asked Questions :</h2>
                    <div class="px-16">
