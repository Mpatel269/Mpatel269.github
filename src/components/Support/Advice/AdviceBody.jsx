                    ...
                    <div class="flex flex-col h-10/12 w-10/12 bg-gray-900 text-white rounded-lg">
                        ...
                        <div class="flex flex-row justify-evenly">
                            <div class="p-4 m-6 rounded-xl border-2 hover:bg-gray-800 transform transition duration-200 hover:scale-105 hover:border-opacity-0">
                                <a href="https://facebook.com/UPOLPEPA" rel='noreferrer' target='_blank'><i class="fab fa-facebook-messenger fa-4x"></i></a>
                            </div>
                            <div class="p-4 m-6 rounded-xl border-2 hover:bg-gray-800 transform transition duration-200 hover:scale-105 hover:border-opacity-0">
                                <i class="fas fa-envelope fa-4x"></i>
                            </div>
                            <div class="p-4 m-6 rounded-xl border-2 hover:bg-gray-800 transform transition duration-200 hover:scale-105 hover:border-opacity-0">
                                <a href="https://www.instagram.com/pepa.up" rel='noreferrer' target='_blank'><i class="fab fa-instagram fa-4x"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
