    ...
    return(
        <div>
            <div class="py-8 bg-pepa-blue flex items-center justify-center ">
                <div class="h-5/6 w-10/12 bg-gray-200 rounded-lg">
                    <div class="h-1/6 p-8 bg-gray-50 rounded-t-lg flex flex-row items-center justify-center text-2xl font-semibold">
                        <div class="px-4">
                    ...
                    <div class="h-4/6 p-8 text-center">
                    ...
                    <div class="rounded-b-lg text-center font-semibold bg-gray-50">
