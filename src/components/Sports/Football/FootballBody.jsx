        ...
        <section class="relative pt-16 bg-blueGray-50">
            <div class="flex flex-wrap w-full mb-4 p-4">
                <div class="w-full mb-6 lg:mb-0">
                    <h1 class="sm:text-4xl text-5xl font-medium font-bold title-font mb-2 text-gray-900">Football</h1>
            ...
            <div class="flex flex-wrap items-center">
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-blue-900">
                    <img alt="..." src="https://images.unsplash.com/photo-1553778263-73a83bab9b0c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Zm9vdGJhbGx8ZW58MHwwfDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"/>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="relative flex flex-col min-w-0 mt-4">
                        ...
                        <p class="mb-4 text-blueGray-500">
                        Info pending from : Brij (<a class="text-blue-500" href="https://maps.app.goo.gl/2Ap3W4PTbgio8bUB9" target="_blank" rel="noopener noreferrer">open in Maps</a>)
                        </p>
                        </div>
                    </div>
                    <div class="relative flex flex-col min-w-0">
